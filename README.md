...
模组不以继续拉长铁砧工艺的主线为主要目标，而是以塑料为媒介，横向扩展铁砧工艺的灵活性与可玩性。
...
- 高粘性树脂桶：可牵引实体并将其粘在方块或其他实体上；未选择实体时，短按可正常使用交互方块，按住超过 0.5 秒则留下树脂胶，不可交互方块会立即放胶。
- 裸露树脂胶：接触胶面的实体和随后放在胶面上的方块都会被粘住，形成的方块组可由活塞或滑轨整体推动；支持 3×3×3 的下落巨型铁砧，实体粘合组会平滑移动。
...
这些层级只负责组织材料与能力的解锁，不代表模组要把本体主线不断向后延伸。后续内容会围绕原油分馏、
