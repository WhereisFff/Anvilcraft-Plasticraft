...
> 状态：TODO-01、TODO-02、TODO-03 实现版；未完成美术资源继续使用占位贴图和占位模型
>
...
> **实现状态**：TODO-01、TODO-02、TODO-03 已按固定背景、坐标和占位资源进入实现与验收；正式模型和按钮美术以后保持现有资源 ID、尺寸与帧规则原位替换。TODO-04 至 TODO-06 仍按各自依赖和资源条件执行。
