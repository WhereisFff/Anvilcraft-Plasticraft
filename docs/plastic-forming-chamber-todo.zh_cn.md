...
| 标准塑料贴图       | PNG 贴图    | 资源文件里16x16的标准塑料块单个面的贴图，用于程序生成的基准                        |
...
> **实现启动条件**：本节目前只用于确定任务边界、依赖和未来验收范围。第 0 章表中的美工资源完成，并且本文被修订为“最终实现版”之前，不开始 TODO-01 至 TODO-06，也不把当前设计稿当作编码依据。

达到上述启动条件后，将整份最终实现版文档和完整资源文件一并交给 AI 并指定某个 TODO；必须遵守以下规则：
