...
/** 工程塑料制品的方块兼容态。 */
public final class EngineeringPlasticBlock extends UniversalPlasticBlock {
    public EngineeringPlasticBlock(Properties properties) {
        super(properties);
    }

    @Override
    protected EntityType<? extends UniversalPlasticEntity> getPlasticEntityType() {
        return PlasticraftEntities.ENGINEERING_PLASTIC.get();
    }

    @Override
    protected ItemStack createDropStack(BlockState state) {
        ItemStack stack = new ItemStack(this);
        PlasticItemData.setMaterial(stack, "engineering_plastic");
