...
/** AnvilCraft-style screen with a pale plastic background. */
public class PlasticAnvilScreen extends ItemCombinerScreen<PlasticAnvilMenu> {
    private static final ResourceLocation BACKGROUND = AnvilcraftPlasticraft.of(
        "textures/gui/crafting/background/plastic_anvil.png"
    );
    ...
    public PlasticAnvilScreen(PlasticAnvilMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderLabels(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        if (this.menu.result.noCostInRenaming && this.menu.result.onlyRenaming || cost > 0) {
