...
- 已交付的施工投影在世界格仍是空气、没有方块实体，但外观与该方块在世界中一致（木头就是不透明木板），并提供真实碰撞，可以站上去；栅栏、墙和门按成品邻接连接；未交付全息可以穿过；空碰撞目标（如红石粉）不产生假碰撞；方块实体内容真实扣料，大型多方块只消耗一份核心；桶装流体交付后返还空桶，树脂捕获先返还 1–3 个树脂再领下一项
