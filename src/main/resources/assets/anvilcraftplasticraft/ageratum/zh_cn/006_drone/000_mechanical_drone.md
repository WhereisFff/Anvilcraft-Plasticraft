...
- 建设无人机发现范围是到最近可执行施工目标的直线距离 128 格，触及距离 1 格；从所有者背包取料飞到接近位交付施工投影，再飞回玩家；取料与返还不计瞬时费，每次交付扣除 2,560 FE
- 已交付的施工投影在世界格仍是空气、没有方块实体，但提供真实碰撞，可以站上去；未交付全息可以穿过；空碰撞目标（如红石粉）不产生假碰撞
- 暂停任务会停止派发并把在途材料返还背包，已交付假方块保留；取消会按进度安静提交已交付方块、返还在途材料，未交付格子保持世界原状
