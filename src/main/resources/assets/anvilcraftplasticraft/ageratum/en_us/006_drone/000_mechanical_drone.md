...
- Delivered construction projections stay as air with no block entity, but they look like the real block in the world (wood is opaque planks) and provide real collision so players can stand on them; fences, walls and doors use the finished connected shape; undelivered holograms can be walked through; empty-collision targets such as redstone dust create no fake collision; block-entity contents are taken as real materials, a large multipart consumes only its core item, bucket fluids return an empty bucket, and resin captures return 1–3 resin before the next claim
