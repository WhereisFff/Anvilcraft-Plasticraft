...
- Cancel quietly commits delivered blocks; a drone that already picked up materials flies back to the owner and puts the in-transit items into the inventory, and undelivered cells stay as they are in the world; a material shortage pauses by default, and switching to skip lets the rest continue then finishes incomplete
